local colors = {
  ...
  -- Theme colors (Black variant)
  principal = "#121212",  -- rgb(18, 18, 18)
  principal_0 = "#1A1A1A", -- rgb(26, 26, 26)
  principal_1 = "#222222", -- rgb(34, 34, 34)
  principal_2 = "#2D2D2D", -- rgb(45, 45, 45)
  principal_3 = "#3D3D3D", -- rgb(61, 61, 61)
  principal_4 = "#555555", -- rgb(85, 85, 85)
  principal_5 = "#777777", -- rgb(119, 119, 119)

  text = "#CECECE", -- rgb(206, 206, 206)

  -- Git colors (solid colors instead of transparent)
  gitInsertedBg = "#202D16", -- solid alternative to rgba(153, 183, 109, 0.15)
  gitRemovedBg = "#2E1616", -- solid alternative to rgba(239, 83, 80, 0.15)
  gitIgnoreExplorer = "#2A2A2A", -- principal.brighten(1.5)

  -- Interface colors
  interBackground = "#121212",
  interBorder = "#222222",
  notificationBadge = "#FFFFFF",

  -- Selection colors (solid alternatives to transparent colors)
  selection_0 = "#1D1D1D", -- solid alt to rgba(119, 119, 119, 0.1)
  selection_1 = "#252525", -- solid alt to rgba(119, 119, 119, 0.2)
  selection_2 = "#2D2D2D", -- solid alt to rgba(119, 119, 119, 0.3)
  selection_3 = "#353535", -- solid alt to rgba(119, 119, 119, 0.4)
  selection_4 = "#313131", -- solid alt to rgba(119, 119, 119, 0.35)
